...
const {validateCreateFile, validateFileIdTokenRoute, validateUpdateFile, validateGetGroupFiles, validateDeleteFile} = require('./fileValidation');
...
router.delete('/delete', (request, response) => executeRoute(request, response, deleteFile, validateDeleteFile));
