...
const {validateCreateChat, validateDeleteChat, validateUpdateChat, validateGetChatsFromGroup} = require('./chatValidation');
...
router.post('/chat_groups', (request, response) => executeRoute(request, response, getChatsInGroup, validateGetChatsFromGroup));
